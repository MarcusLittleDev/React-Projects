...
export function* authUserSaga(action) {
    yield put(actions.authStart());
        ...
        let url = "https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyAnkSCtYNVRyzvHhOc6xN5-J38vFCxNXss";
        if (!action.isSignUp) { 
            url = "https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=AIzaSyAnkSCtYNVRyzvHhOc6xN5-J38vFCxNXss"
        }
        try {
